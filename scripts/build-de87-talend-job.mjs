...
// SnowflakeConnection block (with encrypted Studio-resolvable creds), lifted
// from the existing job. Already has role=DATA_ENGINEER, db=ODS, schema=CONSOLIDATION.
const snowflakeConn = fs.readFileSync(SF_CONN_BLOCK_FILE, "utf-8").trim();
